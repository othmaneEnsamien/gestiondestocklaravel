                                    ...
                                    <form method="POST"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="id_categorie" name="id_categorie"
                                                onchange="loadSousCategories(this.value)" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="id_souscategorie" name="id_souscategorie"
                                                required disabled>
...
@push('scripts')
    <script>
        function loadSousCategories(categorieId) {
            ...
            $.ajax({
                url: '/souscategories/' +
                    categorieId, // Remplacez '/souscategories' par votre URL de récupération des sous-catégories
                type: 'GET',
                success: function(response) {
                    // Supprimez l'option de chargement
                    sousCategorieSelect.html('');

                    // Ajoutez les options de sous-catégorie récupérées
                    ...
                    // Activez le champ de sélection des sous-catégories
